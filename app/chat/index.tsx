...
export default function ChatListScreen() {
  ...
  const load = useCallback(() => fetchConversations(activeTab), [fetchConversations, activeTab]);
        ...
        {isPendingRecipient && (
          <View style={styles.requestActions}>
            <TouchableOpacity
              ...
              onPress={async (e) => { e.stopPropagation(); await acceptConversation(item.id); load(); }}
            >
              <Text style={styles.acceptBtnText}>Accept</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.declineBtn}
              onPress={async (e) => { e.stopPropagation(); await declineConversation(item.id); load(); }}
            >
          ...
          <View style={styles.empty}>
            ...
            <Text style={styles.emptySub}>
              {activeTab === 'requests'
                ...
                : 'Start a chat from an alert interest.'}
            </Text>
          </View>
        }
      />
